...
def test():
    ...
    iterations = 4000
    keylen = 16
    ret = pbkdf2( password, salt, iterations, keylen )
    print ret.encode("hex")

    salt = "d77ce46a 68697e08 b76ac91d e9117541".replace(" ", "").decode("hex")
    iterations = 100000
    password = "12345678"
    ret = pbkdf2( password, salt, iterations, keylen )
    print ret.encode("hex")  # should be 1528f404 a5064744 5fff8a92 a90b1bb6
